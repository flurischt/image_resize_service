...
class TestFileSystemStorage(unittest.TestCase):
    ...
    def test_illegal_mode(self):
        self.assertRaises(ValueError, self.storage.get, self.project, "some", "png", "crop")
        self.assertRaises(ValueError, self.storage.get, self.project, "some", "png", None, (200, 200))
        self.assertRaises(ValueError, self.storage.get, self.project, "some", "png", "notAllowed", (200, 200))
    ...
    def test_delete_image(self):
        ...
        with open(self._test_image_path('%s.%s' % (image_name, image_extension)), 'r') as png_file:
            ...
            original_image_path = os.path.join(self.storage_dir,
                                               self.project, "%s.%s" % (image_name, image_extension))
